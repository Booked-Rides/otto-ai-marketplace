...
| `miles-limoanywhere` (`.mcp.json`) | Bundled stdio server, read-only | operator's machine |
| `miles-gohighlevel` (`.mcp.json`) | Remote connector, OAuth via Booked Rides | Railway |
