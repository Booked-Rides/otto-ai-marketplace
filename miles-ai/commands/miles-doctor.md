---
description: Diagnose the Miles AI setup and report in plain language
---

Check the Miles AI setup and report what's working in plain language. The
...
2. If the hosted Miles AI GoHighLevel connector is also present in this
